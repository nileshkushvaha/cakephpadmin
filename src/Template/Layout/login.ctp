...
<head>
  ...
  <!-- Theme style --><?= $this->Html->css(['../assets/css/style.css','../assets/css/aos.css','../assets/css/jquery-ui','../assets/css/admin.css']); ?>
...
<?= $this->Html->script(['jquery.min.js','../assets/js/jquery-ui','../assets/js/bootstrap.bundle.min.js','../assets/js/aos.js','jquery.validate.min','jquery-additional-methods.min','../assets/js/main.js']); ?>
