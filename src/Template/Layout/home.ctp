...
<head>
  ...
  <!-- Font CSS -->
  <?= $this->Html->css(['../assets/css/slicknav.css','../assets/css/animate.min.css','../assets/css/fontawesome-all.min.css','../assets/css/themify-icons.css','../assets/css/style.css']); ?>
...
<?= $this->Html->script(['../assets/js/modernizr.min.js','../assets/js/jquery.min.js','../assets/js/popper.min.js','../assets/js/bootstrap.min.js','../assets/js/jquery.slicknav.min.js','../assets/js/wow.min.js','../assets/js/jquery.sticky.js','../assets/js/jquery.sticky.js','../assets/js/main.js']); ?>
