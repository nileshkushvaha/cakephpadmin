...
$this->Breadcrumbs->add(__('Edit Menu ( ' . $menu->menu_title .' ) '));
?>

  <!-- Main content -->
  <section class="content menu edit form">
    <div class="row">
      <!-- left column -->
      <div class="col-md-12">
        ...
        <div class="box box-success">
          <div class="box-header with-border">
            <h3 class="box-title">
            <?= __('Menu') ?>
              <small><?= __('Edit Menu  ( ' . $menu->menu_title .' ) ') ?></small>
          </h3>
          ...
          <!-- form start -->
          <?php
          echo $this->Form->create($menu,['id' => 'menu-edit-frm']); ?>
          <div class="box-body">
            <?php
              echo $this->Form->control('menu_region_id', ['options' => $menuRegions]);
            echo $this->Form->control('parent_id', ['options' => $menuParent, 'label' => __('Parent'), 'empty'=>__('Select Parent Menu')]);
