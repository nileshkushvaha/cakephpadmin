 ...
 */
$this->assign('title',__('Password History'));
$this->Breadcrumbs->add(__('Password History'));
      ...
      <div class="col-xs-12">
        ...
        <div class="box box-primary">
          <div class="box-header">
            <h3 class="box-title">Password History of <strong><?=$userName?></strong></h3>            
          </div>
            ...
            <table class="table table-hover table-bordered">
              <thead>
                <tr>
                    ...
                    <th scope="col"><?= $this->Paginator->sort('Last Change') ?></th>
              ...
              <tbody>
                ...
                $i = 1;
                foreach ($changePassword as $user): ?>
                  <tr>
                    <td><?= $this->Number->format($i+$counter) ?>.</td>
                    <td><?= date('Y-m-d H:i A',strtotime($user->change_time)) ?></td>
                    <td><?= inet_ntop(stream_get_contents($user->ip_address)) ?></td>
                  </tr>
                  <?php $i++;
                  endforeach; ?>
                  <?php if(count($changePassword) == 0):?>
                  <tr>
