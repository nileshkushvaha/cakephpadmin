 ...
 */
$this->assign('title',__('Add New Photo Gallery Category'));
$this->Breadcrumbs->add(__('Photo Gallery Categories'),['action'=>'index']);
$this->Breadcrumbs->add(__('Add New Photo Gallery Category'));
      ...
      <div class="col-md-12">
        ...
        <div class="box box-success">
          <div class="box-header with-border">
            <h3 class="box-title">
              <?= __('Gallery Category') ?>
              <small><?= __('Add New Photo Gallery Category') ?></small>
            </h3>
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <?= $this->Form->create($galleryCategory,['id' => 'galleryCategory-add-frm']); ?>
            <div class="box-body">
              <?php
