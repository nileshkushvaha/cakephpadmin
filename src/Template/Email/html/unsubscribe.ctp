						...
						<table>
							<tr>
								<td style="padding:10px;">
									<a href="<?php echo $base_url ?>" style=" width:28%;"><?= $this->Html->image("../assets/images/logo.png",["alt" => "logo",'fullBase' => true]) ?></a>
								</td>
							</tr>
						</table>
					</td>
				...
				<tr>
					<td style="padding:20px;">
						<table cellpadding="0" cellspacing="0" width="650px" align="left">
							<tr>
								<td>
									<p style="font-size:20px; line-height:23px;text-align:justify; color:#080C0E; font-family:arial;">Please Confirm Subscription</p>
								</td>
							</tr>
							<tr>
								<td style="padding-top:40px;">
									<p><a href="<?php echo $base_url.'home/unsubscribe?q1='.$encodeEmail;?>" style="font-size:18px; color:#fff; line-height:20px; background:#00b6f0; padding:10px;">Yes, Subscribe me to this list.</a></p>
								</td>
							</tr>
						</table>
					</td>
