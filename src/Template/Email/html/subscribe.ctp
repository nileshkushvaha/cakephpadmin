						...
						<table cellpadding="0" cellspacing="0" width="650px" align="left">
							...
							<tr>
								<td style="padding-top:40px;">
									<p><a href="<?php echo $base_url.'home/confirm_subscription?q1='.$encodeEmail;?>" style="font-size:18px; color:#fff; line-height:20px; background:#00b6f0; padding:10px;">Yes, Subscribe me to this list.</a></p>
								</td>
							</tr>
						</table>
					</td>
