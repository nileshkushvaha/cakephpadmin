  ...
  class CaptchaComponent extends Component	{
    ...
    private $themes = array(
      ...
      'login'=>array(
        ...
        'txtcolor'=>array(3, 91, 191),
        'noisecolor'=>array(159, 200, 254)
      )
    );
    ...
    public function beforeRender() {
        $this->Controller->helpers['Captcha'] = array_merge($this->__getSettings(), array('controller'=>$this->Controller->request->getParam('controller'), 'action'=>'captcha'));
    }
